...
import org.mule.newrelic.plugins.jolokia.probes.ApplicationProbe;
import org.mule.newrelic.plugins.jolokia.reporters.NewRelicReporter;
...
public class JolokiaAgent extends Agent implements NewRelicAgent {

    private static final Logger logger = Logger.getLogger(JolokiaAgent.class);

    public static final String GUID = "org.mule.newrelic.plugins.jolokia";
    public static final String VERSION = "1.0.0";

    private final String name;
    private final List<Poller> pollers;

    public JolokiaAgent(String name, String pluginName, String pluginVersion) {
